...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] mb-16">
      <h1 className="text-[70px] font-black text-[#4A2C2A] leading-tight cursor-default drop-shadow-[0_3px_3px_rgba(0,0,0,0.7)] text-center">
      ...
      <span className="text-[#4A2C2A] text-xl mt-4 font-medium text-center max-w-2xl subtitle-text">
        An <span className="font-semibold">Interactive video player</span> so
        that you can Laugh, Learn, and Stream the Fun!
      </span>
